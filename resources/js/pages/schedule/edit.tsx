...
import { AlertCircle, Calendar, Clock, FileText, Save, Settings, User as UserIcon } from 'lucide-react';
                ...
                <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
                    ...
                    <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
                        <div className="flex items-center gap-3">
                            <div>
                                <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Edit Schedule</h1>
                                <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">Update task schedule and assignment details</p>
                            </div>
                        </div>
                    </motion.div>
